...
class NotifyTenderBlockController extends Controller
{
    use Loger;
    ...
    public function __invoke(Request $request, int $chat_id)
    {
        ...
        $this->log('NotifyTenderBlockController $telegramUser', $telegramUser);
        Notification::send($telegramUser, new TenderBlock());
