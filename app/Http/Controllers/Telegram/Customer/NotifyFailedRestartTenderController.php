...
class NotifyFailedRestartTenderController extends Controller
{
    use Loger;
    ...
    public function __invoke(Request $request, int $chat_id)
    {
        ...
        $this->log('NotifyFailedRestartTenderController $telegramUser', $telegramUser);
        Notification::send($telegramUser, new FailedRestartTender());
