...
class NotifyApplicationCanceledController extends Controller
{
    use Loger;
    ...
    public function __invoke(Request $request, int $chat_id)
    {
        ...
        $this->log('NotifyApplicationCanceledController $telegramUser', $telegramUser);
        Notification::send($telegramUser, new ApplicationCanceled());
