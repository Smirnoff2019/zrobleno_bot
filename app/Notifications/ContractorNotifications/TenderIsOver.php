...
class TenderIsOver extends Notification
{
    use Queueable;
...
*Спешим Вам сообщить*! Тендер *"Ремонт двух комнат
в новострое"* окончен!
...
[Посмотреть детали](http://customer.zrobleno.com.ua/tender)')
            ->file(public_path('images/bot_statuses/We-inform-about-the-end-of-the-tender.png'), 'photo');
    }
