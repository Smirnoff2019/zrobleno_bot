...
class AccountReplenished extends Notification implements ShouldQueue
{
    use Queueable;
...
*Спешим Вам сообщить*! Ваш счёт был удачно пополнен
на *1200* грн.
...
[Посмотреть детали](http://customer.zrobleno.com.ua/tender)')
            ->file(public_path('images/bot_statuses/Your-account-has-been-successfully-funded.png'), 'photo');
    }
