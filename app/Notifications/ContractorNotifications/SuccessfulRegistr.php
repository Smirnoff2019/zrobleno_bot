...
class SuccessfulRegistr extends Notification
{
    use Queueable;
...
*Спешим Вам сообщить*! Вы успешно прошли регистрацию
на *ТЕНДЕР*!
...
[Посмотреть детали](http://customer.zrobleno.com.ua/tender)')
            ->file(public_path('images/bot_statuses/You-have-successfully-joined-the-tender.png'), 'photo');
    }
