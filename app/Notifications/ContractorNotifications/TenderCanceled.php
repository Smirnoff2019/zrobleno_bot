...
class TenderCanceled extends Notification
{
    use Queueable;
...
*Спешим Вам сообщить*! К сожалению, тендер *"Ремонт
двух комнат в новострое"* анулирован!

С деталями можно ознакомиться перейдя по ссылке под
сообщением!

[Посмотреть детали](http://customer.zrobleno.com.ua/tender)')
            ->file(public_path('images/bot_statuses/The-tender-was-canceled.png'), 'photo');
    }
