...
class AccountWithdrawn extends Notification
{
    use Queueable;
...
*Спешим Вам сообщить*! С Вашего счёта было снято *1200* грн.

С деталями можно ознакомиться перейдя по ссылке под
сообщением!

[Посмотреть детали](http://customer.zrobleno.com.ua/tender)')
            ->file(public_path('images/bot_statuses/Warning.png'), 'photo');
    }
