...
class ApplicationCanceled extends Notification
{
    use Queueable;
...
*Спешим Вам сообщить*! Ваша завка на тендер *"Ремонт
двух комнат в новострое"* была анулирована.

С деталями можно ознакомиться перейдя по ссылке под
сообщением!

[Посмотреть детали](http://customer.zrobleno.com.ua/tender)')
            ->file(public_path('images/bot_statuses/Your-application-has-been-canceled.png'), 'photo');
    }
