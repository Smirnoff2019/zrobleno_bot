...
class ContractorConfirmed extends Notification
{
    use Queueable;
...
*Мы поздравляем Вас*! По Вашему тендеру *"Ремонт
двух комнат в новострое"* подрядчик *подтвердил*
сделку.
...
[Посмотреть детали](http://customer.zrobleno.com.ua/tender)')
            ->file(public_path('images/bot_statuses/Congratulations.png'), 'photo');
    }
